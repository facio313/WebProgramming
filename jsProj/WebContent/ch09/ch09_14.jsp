	...
	*/
	$(function(){
		...
		$("#first-child").click(function(){
	        ...
	        //문) 배경색을 노랑으로 바꿔보자
	        //$("div:nth-of-type(1) :first-child").css("backgroundColor", "yellow");
			//$("div:nth-of-type(2) :first-child").css("backgroundColor", "yellow");
			//$("div:nth-of-type(3) :first-child").css("backgroundColor", "yellow");
			//$("div:nth-of-type(4) :first-child").css("backgroundColor", "yellow");
			$("p:first-child").css("backgroundColor", "yellow");
	    });
